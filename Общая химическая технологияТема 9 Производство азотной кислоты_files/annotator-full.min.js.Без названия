...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.countAnnotations = function() {
      if (this.plugins['Store']) {
        return this.plugins['Store'].countAnnotations();
      } else {
        return 0;
      }
    };
    ...
    Annotator.prototype.showViewer = function(annotations, location) {
      ...
      this.viewer.load(annotations, location);
      return this.publish('annotationViewerShown', [this.viewer, annotations]);
    };

    Annotator.prototype.startViewerHideTimer = function(event) {
      var annotations,
        _this = this;
      ...
      if (!this.viewerHideTimer) {
        return this.viewerHideTimer = setTimeout((function() {
          return _this.viewer.hide(annotations);
        }), 250);
      }
    };
    ...
    Annotator.prototype.isAnnotatorViewer = function(element) {
      return !!$(element).parents().andSelf().filter('[class^=annotator-viewer]').not(this.wrapper).length;
    };

    Annotator.prototype.isAnnotatorEditor = function(element) {
      return !!$(element).parents().andSelf().filter('[class^=annotator-editor]').not(this.wrapper).length;
    };
  ...
  Annotator.Editor = (function(_super) {
    ...
    Editor.prototype.html = "<div class=\"annotator-outer annotator-editor\">\n  <form class=\"annotator-widget\">\n    <ul class=\"annotator-listing\"></ul>\n    <div class=\"annotator-controls\">\n      <a href=\"#cancel\" class=\"annotator-cancel\">" + _t('Скасувати') + "</a>\n<a href=\"#save\" class=\"annotator-save annotator-focus\">" + _t('Зберегти') + "</a>\n    </div>\n  </form>\n</div>";
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype.countAnnotations = function() {
  ...
  Annotator.Plugin.Filter = (function(_super) {
    ...
    Filter.prototype.html = {
      element: "<div class=\"annotator-filter\">\n  <strong><img align='top' src='/javascripts/annotator/img/icon.png' />" + Annotator._t('Виділіть текст, щоб додати зауваження. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Послідовно переглянути зауваження: ') + "</strong>\n<span class=\"annotator-filter-navigation\">\n  <button class=\"annotator-filter-previous\">" + Annotator._t('Previous') + "</button>\n<button class=\"annotator-filter-next\">" + Annotator._t('Next') + "</button>\n</span>\n<strong>Всього зауважень: <i style='font-size:120%;font-weight:bold; color: #00468a' id='annot-counter'>0</i></strong>" ,
      filter: ""
    };
    ...
    Filter.prototype.updateHighlights = function() {
      ...
      jQuery("#annot-counter").text(this.annotator.countAnnotations());
    ...
    Filter.prototype._findNextHighlight = function(previous) {
      ...
      if(typeof(window.parent.setMinFrameHeight)=='function') {
        window.parent.setMinFrameHeight();  
      }
